		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['info']) {
					...
					alertRow.append('<div class="alert alert-info"><i class="fa fa-info-circle"></i> ' + json['info'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
				}
...
var product = {
    'print': function (product_id) {
        $.ajax (
            {
                url: 'http://localhost/startech/index.php?route=product/product/printpro',
                type: 'post',
                data: 'product_id=' + product_id,
                dataType: 'html',
